...
<body>
<div class=wraper>
<a href=index.php>Home</a> - <a href=bulkupdatestd.php>Update Bulk Students</a> - <a href=updatebyfamily.php>Update by Family</a> - Update Family Medical Fee

<h2>Update Family Medical Fee</h2>
...
$update = mysql_query("UPDATE iphs.students SET medical = '$data' WHERE students.faimlynum = '$fn'",$con);
if($update){
...
echo "<form action=updatefamilymedical.php method=post >";
echo "<table>
