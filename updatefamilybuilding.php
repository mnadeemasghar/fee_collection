...
<body>
<div class=wraper>
<a href=index.php>Home</a> - <a href=bulkupdatestd.php>Update Bulk Students</a> - <a href=updatebyfamily.php>Update by Family</a> - Update Family Building Fund

<h2>Update Family Building Fund</h2>
...
$update = mysqli_query($con,"UPDATE iphs.students SET building = '$data' WHERE students.faimlynum = '$fn'");
if($update){
...
echo "<form action=updatefamilybuilding.php method=post >";
echo "<table>
